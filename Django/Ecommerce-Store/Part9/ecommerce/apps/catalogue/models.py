...
class Product(models.Model):
    ...
    users_wishlist = models.ManyToManyField(settings.AUTH_USER_MODEL, blank=True, related_name="user_wishlist")
...
class ProductImage(models.Model):
    ...
    alt_text = models.CharField(
        ...
        help_text=_("Please add alternative text for the image"),
        max_length=255,
        null=True,
        blank=True,
    )
